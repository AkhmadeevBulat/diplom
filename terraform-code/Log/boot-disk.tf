# Загрузочный диск для Kibana-сервера

resource "yandex_compute_disk" "boot-disk-6" {
  name     = "boot-disk-6"
  type     = "network-hdd"
  zone     = "ru-central1-a"
  size     = "10"
...
# Загрузочный диск для ElasticSearch-сервера
...
# Загрузочный диск для Zabbix-сервера
